<div class="card mb-3">
    <div class="card-body rounded-soft bg-gradient">
      <div class="row text-white align-items-center no-gutters">
        ...
        <div class="col-auto d-none d-sm-block">
          <a href="<?= $this->url->get('admin/projects') ?>" class="btn btn-light btn-lg">Create New Project</a>
        </div>
  ...
  <div class="card-deck">
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
      <div class="bg-holder bg-card" style="background-image:url(<?= $this->url->get('assets/extra/img/illustrations/corner-1.png') ?>);"></div>
      <!--/.bg-holder-->
      <div class="card-body position-relative">
        <h6>Projects Submitted<span class="badge badge-soft-warning rounded-capsule ml-2"></span></h6>
        <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-warning" data-countupp='{"count":<?= $projects ?>,"format":"alphanumeric"}'><?= $projects ?></div><a href="<?= $this->url->get('admin/projects/list') ?>" class="font-weight-semi-bold fs--1 text-nowrap" href="#!">See all<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
      </div>
    </div>
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
      <div class="bg-holder bg-card" style="background-image:url(<?= $this->url->get('assets/extra/img/illustrations/corner-2.png') ?>);"></div>
      <!--/.bg-holder-->
      <div class="card-body position-relative">
    ...
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
      <div class="bg-holder bg-card" style="background-image:url(<?= $this->url->get('assets/extra/img/illustrations/corner-3.png') ?>);"></div>
      <!--/.bg-holder-->
      <div class="card-body position-relative">
        <h6>Xtremecardz Portfolio<span class="badge badge-soft-success rounded-capsule ml-2"></span></h6>
        <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif" data-countup='{"count":5,"format":"comma","prefix":""}'>0</div><a class="font-weight-semi-bold fs--1 text-nowrap" href="<?= $this->url->get('admin/projects/') ?>">View all<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
      </div>
    </div>
  </div>
