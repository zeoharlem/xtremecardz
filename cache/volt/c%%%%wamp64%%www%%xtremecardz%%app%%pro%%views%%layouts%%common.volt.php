...
<div class="card mb-3">
    <div class="card-body d-flex justify-content-between">
      ...
      <div class="d-flex align-items-center">
            ...
            <a href="<?= $this->url->get('pro/projects') ?>" class="btn btn-falcon-default btn-sm ml-2" type="button">Add New Project &nbsp;<span class="fas fa-plus"></span></a>
        </div>
...
<!-- ===============================================-->
      ...
      <script src="<?= $this->url->get('assets/extra/js/custom-pro-view.js') ?>"></script>
