          ...
          <ul class="navbar-nav d-none d-lg-block">
            ...
            <li class="nav-item dropdown-toggle"><a class="nav-link" href="#">ID Cards</a>
              <ul class="dropdown-menu">
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Metal ID Cards</a></li>
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Plastic ID Cards</a></li>
            ...
            <li class="nav-item dropdown-toggle"><a class="nav-link" href="#">Business Cards</a>
              <ul class="dropdown-menu">
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Metal Business Cards</a></li>
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Plastic Business Cards</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown-toggle"><a class="nav-link" href="#">Corporate Personnel</a>
              <ul class="dropdown-menu">
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Corporate VIP Cards</a></li>
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Corporate Loyalty Cards</a></li>
                <li class="dropdown-item"><a href="<?= $this->url->get('portfolio') ?>">Corporate Loyalty Cards</a></li>
              </ul>
            </li>
