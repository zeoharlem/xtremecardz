...
<div class="container pb-5 mb-3">
  ...
  <ul class="nav nav-tabs nav-tabs-style-2 mb-4">
    ...
    <li class="nav-item"><a class="nav-link" href="#" data-filter=".mobile-apps">Metal Cards&nbsp;<sup>3</sup></a></li>
    <li class="nav-item"><a class="nav-link" href="#" data-filter=".web-design">Plastic ID Cards&nbsp;<sup>1</sup></a></li>
  ...
  <div class="isotope-grid filter-grid cols-3">
    ...
    <div class="grid-item mobile-apps mb-30 pb-2">
      <div class="card portfolio-card"><a class="portfolio-thumb" href="portfolio-single-side-gallery-grid.html"><img src="<?= $this->url->get('assets/images/l2.jpg') ?>" alt="Portfolio Thumbnail"/></a>
        <div class="card-body">
    ...
    <!-- Portfolio Item-->
    <div class="grid-item web-design mb-30 pb-2">
      <div class="card portfolio-card"><a class="portfolio-thumb" href="portfolio-single-side-gallery-list.html"><img src="<?= $this->url->get('assets/images/l1.jpg') ?>" alt="Portfolio Thumbnail"/></a>
        <div class="card-body">
    ...
    <!-- Portfolio Item-->
    <div class="grid-item Corporate Cards mb-30 pb-2">
      <div class="card portfolio-card"><a class="portfolio-thumb" href="portfolio-single-wide-slider.html"><img src="<?= $this->url->get('assets/images/l3.jpg') ?>" alt="Portfolio Thumbnail"/></a>
        <div class="card-body">
        ...
        <div class="card-footer">
          <div><a class="tag-link" href="#">Corporate Cards</a></div>
    ...
    <!-- Portfolio Item-->
    <div class="grid-item mobile-apps mb-30 pb-2">
      <div class="card portfolio-card"><a class="portfolio-thumb" href="portfolio-single-wide-gallery.html"><img src="<?= $this->url->get('assets/images/l2.jpg') ?>" alt="Portfolio Thumbnail"/></a>
        <div class="card-body">
    ...
    <!-- Portfolio Item-->
    <div class="grid-item interior-design mb-30 pb-2">
      <div class="card portfolio-card"><a class="portfolio-thumb" href="portfolio-single-side-gallery-grid.html"><img src="<?= $this->url->get('assets/images/l3.jpg') ?>" alt="Portfolio Thumbnail"/></a>
        <div class="card-body">
    ...
    <!-- Portfolio Item-->
    <div class="grid-item branding mb-30 pb-2">
      <div class="card portfolio-card"><a class="portfolio-thumb" href="portfolio-single-side-gallery-list.html"><img src="<?= $this->url->get('assets/images/l1.jpg') ?>" alt="Portfolio Thumbnail"/></a>
        <div class="card-body">
          <div class="portfolio-meta"><span><i class="fe-icon-user"></i>Emma Johnson</span></div>
          <h5 class="portfolio-title"><a href="portfolio-single-side-gallery-list.html">Apple Package Design</a></h5>
        </div>
        <div class="card-footer">
