    ...
    <li class="nav-item dropdown"><a class="nav-link pr-0" id="navbarDropdownUser" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="dropdown-menu dropdown-menu-right py-0" aria-labelledby="navbarDropdownUser">
        <div class="bg-white rounded-soft py-2">
          ...
          <a class="dropdown-item" href="<?= $this->url->get('pro/settings') ?>">Profile &amp; account</a>
          <a class="dropdown-item" href="#!">Feedback</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?= $this->url->get('pro/settings/password') ?>">Settings</a>
          <a class="dropdown-item font-weight-bold text-warning" href="<?= $this->url->get('pro/logout') ?>"><span>Logout</span></a>
        </div>
      </div>
    </li>
  </ul>
