        ...
        <div class="col-xl-9 col-lg-8 pb-5">
            ...
            <div class="wizard">
                <div class="wizard-steps d-flex flex-wrap flex-sm-nowrap justify-content-between">
                    <div class="wizard-step active">1. Address</div><a class="wizard-step" href="<?= $this->url->get('cart/payment') ?>">2. Payment</a></div>
                        <div class="wizard-body">
                          <h3 class="h5 pb-2">Billing Address</h3>

                          <form method="POST" id="formBillingRegister">
                                            <div class="row">
                                              <div class="col-sm-6">
                        ...
                        <div class="wizard-footer d-flex justify-content-between"><a class="btn btn-secondary my-2" href="<?= $this->url->get('portfolio') ?>"><i class="fe-icon-arrow-left"></i><span class="d-none d-sm-inline-block">Back to cart</span></a>
                        <button class="btn btn-primary my-2" id="submitBillingRegister" type="submit"><span class="d-none d-sm-inline-block">Continue</span><i class="fe-icon-arrow-right"></i></button></div>
                      </div>
