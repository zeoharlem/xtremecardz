    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-8">
          ...
          <p class="mt-2">Invoice explanation on it's generated for the clients.</p><a class="btn btn-link pl-0 btn-sm" href="<?= $this->url->get('admin/dashboard?token=') ?><?php echo uniqid('xL'); ?>"> Projects Created<span class="fas fa-chevron-right ml-1 fs--2"></span></a>
        </div>
      </div>
    </div>
</div>
...
<!-- ===============================================-->
      ...
      <script src="<?= $this->url->get('assets/extra/js/custom-admin-view.js') ?>"></script>
