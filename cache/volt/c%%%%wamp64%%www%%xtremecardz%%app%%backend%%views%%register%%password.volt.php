...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= $this->url->get('assets/img/favicons/apple-touch-icon.png') ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= $this->url->get('assets/img/favicons/favicon-32x32.png') ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= $this->url->get('assets/img/favicons/favicon-16x16.png') ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?= $this->url->get('assets/img/favicons/favicon.ico') ?>">
    <link rel="manifest" href="<?= $this->url->get('assets/img/favicons/manifest.json') ?>>
    <meta name="msapplication-TileImage" content="<?= $this->url->get('assets/img/favicons/mstile-150x150.png') ?>">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="container">
        <div class="row flex-center min-vh-100 py-6">
          <div class="col-sm-11 col-md-9 col-lg-7 col-xl-6 col-xxl-5"><a class="d-block text-center mb-4" href="<?= $this->url->get('backend/') ?>"><img class="mr-2" src="<?= $this->url->get('assets/extra/img/xtreme-logo-dark.png') ?>" alt="" width="150" /></a>
            <div class="card">
    ...
    <script src="<?= $this->url->get('assets/extra/js/jquery.form.min.js') ?>"></script>
    ...
    <script src="<?= $this->url->get('assets/extra/js/pages/register.js') ?>"></script>
