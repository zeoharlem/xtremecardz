      ...
      <main class="main" id="top">
        ...
        <div class="container">
          <div class="row flex-center min-vh-100 py-6">
            ...
            <a class="d-block text-center mb-4" href="<?= $this->url->get('backend') ?>"><img class="mr-2" src="<?= $this->url->get('assets/extra/img/xtreme-logo-dark.png') ?>" alt="" width="150" /><span class="text-sans-serif font-weight-extra-bold fs-5 d-inline-block"></span></a>
              <?= $this->flash->output() ?>
              <div class="card">
                <div class="card-body p-5">
                  <div class="row text-left justify-content-between">
                    ...
                    <div class="col-auto">
                      <p class="fs--1 text-600">or <a href="<?= $this->url->get('backend/register') ?>">Create an account</a></p>
                    </div>
                  </div>
                  <form method="POST" action="<?= $this->url->get('backend/login') ?>">
                    ...
                    <div class="form-group mb-0">
                      <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 pl-sm-1"><a class="btn btn-outline-facebook btn-lg mt-2 btn-block" href="#"><span class="fab fa-facebook mr-2" data-fa-transform="grow-8"></span> facebook</a></div>
                      </div>
                    </div>
                  </form>
                </div>
