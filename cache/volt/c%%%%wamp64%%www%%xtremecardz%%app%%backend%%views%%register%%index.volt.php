    ...
    <main class="main" id="top">
      ...
      <div class="container">
        ...
        <div class="row flex-center min-vh-100 py-6">
          ...
          <a class="d-block text-center mb-4" href="<?= $this->url->get('assets/extra/index-2.html') ?>"><img class="mr-2" src="<?= $this->url->get('assets/extra/img/xtreme-logo-dark.png') ?>" alt="" width="150" /><span class="text-sans-serif font-weight-extra-bold fs-5 d-inline-block"></span></a>
            <?= $this->flash->output() ?>
            <div class="card">
              <div class="card-body p-5">
                <div class="row text-left">
                  ...
                  <div class="col-auto">
                    <p class="fs--1 text-600">Have an account? <a href="<?= $this->url->get('backend/') ?>">Login</a></p>
                  </div>
                </div>

                <form id="registerForm" method="POST" action="<?= $this->url->get('backend/login/') ?>">
