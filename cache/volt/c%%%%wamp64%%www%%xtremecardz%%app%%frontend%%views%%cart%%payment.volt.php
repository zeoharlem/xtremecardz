        ...
        <div class="col-xl-9 col-lg-8 pb-5">
            ...
            <div class="wizard">
                <div class="wizard-steps d-flex flex-wrap flex-sm-nowrap justify-content-between">
                    <div class="wizard-step">1. Address</div><a class="wizard-step active" href="<?= $this->url->get('cart/payment') ?>">2. Payment</a></div>
                                                  ...
                                                  <div class="card">
                                                    ...
                                                    <div class="collapse show" id="card" data-parent="#accordion" role="tabpanel">
                                                      <div class="card-body px-0">
                                                        <p>We accept following credit cards:&nbsp;&nbsp;<img class="d-inline-block align-middle" src="<?= $this->url->get('assets/img/credit-cards.png') ?>" style="width: 120px;" alt="Cerdit Cards"></p>
                        ...
                        <div class="wizard-footer d-flex justify-content-between"><a class="btn btn-secondary my-2" href="<?= $this->url->get('cart/checkout/') ?>"><i class="fe-icon-arrow-left"></i><span class="d-none d-sm-inline-block">Back to Billing Section</span></a></div>
                      </div>
