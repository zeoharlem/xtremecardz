<div class="card">
    ...
    <div class="card-body bg-light p-0">
      ...
      {% for keys,values in pager.getPaginate().items %}
        <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1" id="{{ values.staff_id }}">
          <div class="bg-white p-3 h-100"><a href="javascript:void(0);">
            <img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="{{url( values.getExtractedImgStaff().image_extracted )}}" alt="" width="100" /></a>
            ...
            <img src="<?php echo @$this->url->get($values->getSignaturesStaff()->image_extracted); ?>" width="50" />
          </div>
        </div>
      {% endfor %}
      </div>
