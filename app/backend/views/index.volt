      ...
      <main class="main" id="top">
        ...
        <div class="container">
          <div class="row flex-center min-vh-100 py-6">
            ...
            <a class="d-block text-center mb-4" href="{{ url('backend') }}"><img class="mr-2" src="{{ url('assets/extra/img/xtreme-logo-dark.png') }}" alt="" width="150" /><span class="text-sans-serif font-weight-extra-bold fs-5 d-inline-block"></span></a>
              {{ flash.output() }}
              <div class="card">
                <div class="card-body p-5">
                  <div class="row text-left justify-content-between">
                    ...
                    <div class="col-auto">
                      <p class="fs--1 text-600">or <a href="{{ url('backend/register') }}">Create an account</a></p>
                    </div>
                  </div>
