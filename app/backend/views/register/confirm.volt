          ...
          <div class="col-sm-11 col-md-9 col-lg-7 col-xl-6 col-xxl-5"><a class="d-block text-center mb-4" href="{{ url('backend/') }}"><img class="mr-2" src="{{ url('assets/extra/img/xtreme-logo-dark.png') }}" alt="" width="150" /></a>
            <div class="card">
              <div class="card-body p-5"><img class="d-block mx-auto mb-4" src="{{ url('assets/img/icons/sent.svg') }}" alt="shield" width="100" />
                ...
                <p>An email has been sent to <code>youremail@domain.com</code>. Please check for an email from the company and Activate your account.</p><a class="btn btn-primary btn-sm mt-3" href="{{ url('backend/') }}"><span class="fas fa-sign-in-alt mr-2"></span>Return to login</a>
              </div>
            </div>
          </div>
        </div>
