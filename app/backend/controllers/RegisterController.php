...
class RegisterController extends BaseController {
    ...
    public function indexAction() {
        if($this->request->isPost()){
            ...
            if($register->create($this->request->getPost())){
                ...
                $this->response->redirect("backend/register?task=".uniqid('xLmR'));
            }
        }
    ...
    public function confirmAction(){
        ...
        return $this->response->redirect("backend/register?task=");
    }
                ...
                if($password == $rpassword){
                    ...
                    if($register){
                        ...
                        if($updateRow){
                            ...
                            return $this->response->redirect('backend/register/password?hash='.$hash.'&email='.$email);
                        }
                    }
                    else{
