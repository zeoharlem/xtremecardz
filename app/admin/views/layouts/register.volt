    ...
    <main class="main" id="top">
      ...
      <div class="container">
        <div class="row flex-center min-vh-100 py-6">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-block text-center mb-4" href="{{ url('assets/extra/index-2.html') }}"><img class="mr-2" src="{{ url('assets/extra/img/illustrations/falcon.png') }}" alt="" width="58" /><span class="text-sans-serif font-weight-extra-bold fs-5 d-inline-block">falcon</span></a>
            <div class="card">
              <div class="card-body p-5">
                <div class="row text-left">
                  ...
                  <div class="col-auto">
                    <p class="fs--1 text-600">Have an account? <a href="log-in.html">Login</a></p>
                  </div>
                </div>
                <form id="formRegisterRow" method="POST">
                  <div class="form-group"><input class="form-control form-control-lg" name="fullname" type="text" placeholder="Company's Name" /></div>
                  <div class="form-group"><input class="form-control form-control-lg" name="email" type="email" placeholder="Email address" /></div>
