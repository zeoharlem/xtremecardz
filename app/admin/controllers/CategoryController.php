...
class CategoryController extends BaseController {
    ...
    public function indexAction(){
        ...
        if($this->request->isPost()){
            ...
            if($category->create($this->request->getPost())){
                ...
                $this->response->redirect("admin/category/?task=successful");
                ...
                $this->response->redirect("admin/category/?task=ERROR");
                return $this->view->setRenderLevel(View::LEVEL_NO_RENDER);
            }
        }
        $this->view->setVars([
    ...
    public function subcategoryAction(){
        ...
        if($this->request->isPost()){
            ...
            if($category->create($this->request->getPost())){
                $this->flash->success("Category Created Successfully");
                $this->response->redirect("admin/category/subcategory?task=successful");
                return $this->view->setRenderLevel(View::LEVEL_NO_RENDER);
            }
            else{
                foreach($category->getMessages() as $key => $value){
                ...
                $this->flash->error(implode(", ", $messageRaw));
                $this->response->redirect("admin/category/subcategory?task=ERROR");
                return $this->view->setRenderLevel(View::LEVEL_NO_RENDER);
            }
        }
        $this->view->setVars([
