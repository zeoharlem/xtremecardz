...
class Register extends BaseModel {
    ...
    public $password, $role, $hash, $register;
    public $date_created, $email, $company_name;
    public static $_message, $_viewPath, $_viewDirLocal, $_params;
    ...
    public function initialize() {
        ...
        $this->belongsTo(
            "register_id",
            "Multiple\\Pro\\Models\\Profile",
            "register_id",
            [
                "reusable"  => true,
                "alias"     => "ProfileRegister"
            ]
        );

        $this->allowEmptyStringValues(['password']);
    }
    ...
    public function getProfileRow(){
        return $this->getRelated("ProfileRegister");
    }

    public function beforeValidationOnCreate() {
        $this->role         = "guest";
        $this->password     = uniqid('pswRL');
    ...
    public function afterCreate() {
        //Perform a mail operation here
        $message    = $this->getDI()->getMailer()->createMessage()
            ->to('theophilus.alamu8@gmail.com','Theophilus')
            ->subject("Xtreme Cardz Notification")
            ->content($this->_headerBaseView().self::$_message.$this->_footerBaseView());
        $message->send();
    }
    ...
    private function _headerBaseView(){
        $bodyMessageFooterRow   = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">
        <html>
        <head>
                     ...
                     <tr>
                        <td align=\"left\" valign=\"top\">
                           <font face=\"'Source Sans Pro', sans-serif\" color=\"#1a1a1a\" style=\"font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;\">
                              <span style=\"font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 42px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;\">Hey <b>{{ params['name'] }}</b>,</span>
                           </font>
        ...
        return $bodyMessageFooterRow;
    }

    private function _footerBaseView(){
        $bodyMessageFooterRow   = "</span></font><div style=\"height: 33px; line-height: 33px; font-size: 31px;\">&nbsp;</div>
                                 ...
                                 <td align=\"center\" valign=\"top\">
                                    <a href=\"\" target=\"_blank\" style=\"display: block; border: 1px solid #27cbcc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;\">
                                       <font face=\"'Source Sans Pro', sans-serif\" color=\"#ffffff\" style=\"font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;\">
                                          <span style=\"font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;\">Activate Now</span>
                                       </font>
                                    </a>
                                 </td>
                              </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td class=\"mob_center\" align=\"left\" valign=\"top\">
                                       ...
                                       <font face=\"'Source Sans Pro', sans-serif\" color=\"#000000\" style=\"font-size: 19px; line-height: 23px; font-weight: 600;\">
                                          <span style=\"font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;\">Debo Atiba</span>
                                       </font>
                                       ...
                                       <font face=\"'Source Sans Pro', sans-serif\" color=\"#7f7f7f\" style=\"font-size: 19px; line-height: 23px;\">
                                          <span style=\"font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;\">Creative Executive Officer at <b>cr8</b></span>
                                       </font>
                                    </td>
                                    <td width=\"18\" style=\"width: 18px; max-width: 18px; min-width: 18px;\">&nbsp;</td>
                                 </tr>
