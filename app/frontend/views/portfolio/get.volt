  ...
  <div class="row">
    ...
    <div class="col-lg-7 mb-3">
      ...
      <div class="row">
        ...
        <div class="col-sm-6"><a class="gallery-item mb-30" href="{{ url('assets/img/portfolio/single/04.jpg') }}" data-fancybox="sideGallery" data-options="{&quot;caption&quot;: &quot;Gallery Image Caption&quot;}"><img src="{{ url('assets/img/portfolio/13.jpg') }}" alt="Gallery Image"/></a></div>
        <div class="col-sm-6"><a class="gallery-item mb-30" href="{{ url('assets/img/portfolio/single/04.jpg') }}" data-fancybox="sideGallery" data-options="{&quot;caption&quot;: &quot;Gallery Image Caption&quot;}"><img src="{{ url('assets/img/portfolio/13.jpg') }}" alt="Gallery Image"/></a></div>

      </div>
    </div>

    {{ partial('partials/projectdetails') }}
  </div>
