  ...
  <div class="row">
    ...
    <div class="col-md-6 pb-5">
      <div class="product-gallery">
        ...
        <div class="row">
            <div class="col-sm-12">
              <a class="gallery-item mb-30" href="{{ url('assets/portfolio/'~mainImg) }}" data-fancybox="sideGallery" data-options="{&quot;caption&quot;: &quot; Image + Design Copyrighted by @2019 Xtremecardz &quot;}"><img src="{{ url('assets/portfolio/'~mainImg) }}" alt="Gallery Image"/></a>
            </div>
