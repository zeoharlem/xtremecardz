        ...
        <div class="col-xl-9 col-lg-8 pb-5">
            ...
            <div class="wizard">
                <div class="wizard-steps d-flex flex-wrap flex-sm-nowrap justify-content-between">
                    <div class="wizard-step active">1. Address</div><a class="wizard-step" href="{{url('cart/payment')}}">2. Payment</a></div>
                        ...
                        <div class="wizard-footer d-flex justify-content-between"><a class="btn btn-secondary my-2" href="{{url('portfolio')}}"><i class="fe-icon-arrow-left"></i><span class="d-none d-sm-inline-block">Back to cart</span></a>
