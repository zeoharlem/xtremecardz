<div class="offcanvas-container is-triggered offcanvas-container-reverse" id="shopping-cart"><span class="offcanvas-close"><i class="fe-icon-x"></i></span>
      <div class="px-4">
        ...
        <div class="widget widget-cart pt-2">
            ...
            <a class="featured-product" href="#">
                <div class="featured-product-thumb"><img src="{{url('assets/accessories/'~value['image'])}}" alt="Product Image"/></div>
    ...
    <header class="navbar-wrapper navbar-sticky">
      <div class="d-table-cell align-middle pr-md-3"><a class="navbar-brand mr-1" href="#"><img src="{{ url('assets/images/xtreme-logo-dark.png') }}" alt="Xtremecardz"/></a></div>
