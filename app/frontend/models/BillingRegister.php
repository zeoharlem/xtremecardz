...
class BillingRegister extends BaseModel {

    public $email, $billing_register_id;
    public $password, $date_registered;
    ...
    public function initialize(){
        ...
        $this->setSource("billing_register");
    }
    ...
    public function afterCreate(){
        ...
        $messageRow = $this->getDI()->getMailer()->createMessage()
            ...
            ->content($this->setHeaderPackageRow().$this->setBodyFullRow().$this->setBodyPackageRow());
        $messageRow->send();
    }

    public function getOrderBillingRegister() {
        return $this->getRelated("OrderBilling");
    }
    ...
    public function validation() {
        ...
        $validate->add("email", new Validation\Validator\Email(
            [
                "model"     => $this,
    ...
    private function setHeaderPackageRow() {
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
            ...
            <head>
                ...
                <title>Xtremecardz Notification</title>
    ...
    private function setBodyFullRow(){
                                    ...
                                    <table border=\"0\" align=\"center\" width=\"590\" cellpadding=\"0\" cellspacing=\"0\" class=\"container590\">
                                        ...
                                        <tr>
                                            <td align=\"center\" height=\"70\" style=\"height:70px;\">
                                                <a href=\"\" style=\"display: block; border-style: none !important; border: 0 !important;\"><img width=\"100\" border=\"0\" style=\"display: block; width: 100px;\" src=\"http://netmartng.com/assets/images/gmanzo.png\" alt=\"\" /></a>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td align=\"center\" style=\"color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;\"
                                    ...
                                    <div style=\"line-height: 35px\">
                                        ...
                                        Welcome to Xtremecardz <span style=\"color: #5caad2;\">E-Commerce</span>
                                    ...
                                    <table border=\"0\" width=\"590\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"container590\">
                                        <tr>
                                            <td align=\"left\" style=\"color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;\">
                                                ...
                                                <p style=\"line-height: 24px;margin-bottom:15px;\">
                                                    Great news, you will now be the first to see exclusive previews of our latest collections, hear about news from the Xtremecardz!
                                                    community and get the most up to date news. Your default password is 123456
                                                </p>
                                                    ...
                                                    <tr>
                                                        <td align=\"center\" style=\"color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;\">
                                                            ...
                                                            <div style=\"line-height: 22px;\">
                                                                <a href=\"http://xtremecardz.com\" style=\"color: #ffffff; text-decoration: none;\">MY ACCOUNT</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <p style=\"line-height: 24px\">
                                                    Love,<br/>
                                                    CEO Xtremecardz,<br/> <b>Atiba Debo</b>
                                                </p>
    ...
    private function setBodyPackageRow() {
        return "<!-- main section -->
                                            ...
                                            <td>
                                                <table border=\"0\" width=\"300\" align=\"left\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;\"
                                                    ...
                                                    <tr>
                                                        <!-- logo -->
                                                        <td align=\"left\">
                                                            <a href=\"\" style=\"display: block; border-style: none !important; border: 0 !important;\"><img width=\"80\" border=\"0\" style=\"display: block; width: 80px;\" src=\"http://netmartng.com/assets/images/gmanzo.png\" alt=\"\" /></a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align=\"left\" style=\"color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;\"
                                                            ...
                                                            <div style=\"color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;\">
                                                                ...
                                                                Email us: <br/> <a href=\"mailto:info@netmartng.com\" style=\"color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;\">contact@netmartng.com</a>
